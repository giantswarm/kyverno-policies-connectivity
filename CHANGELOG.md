...
- Update `inject-proxy-env` policy to have `grafana-postgresql` pods in its scope.
...
[Unreleased]: https://github.com/giantswarm/kyverno-policies-connectivity/compare/v0.7.0...HEAD
